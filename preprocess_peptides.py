...
ONE_EDIT_OUTPUT_FILE = os.path.join(WORKING_DIR, 'self_peptides_one_edit_{}.pkl'.format(MODULUS))
with open(ONE_EDIT_OUTPUT_FILE, 'wb') as f:
    pickle.dump(one_edit, f)

TWO_EDITS_OUTPUT_FILE = os.path.join(WORKING_DIR, 'self_peptides_two_edits_{}.pkl'.format(MODULUS))
with open(TWO_EDITS_OUTPUT_FILE, 'wb') as f:
    pickle.dump(two_edits, f)
